						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								...
								<sec:authorize access="isAuthenticated()">
									...
									<li><a class="dropdown-item" href="/board/register">Board
											Register</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								...
								<sec:authorize access="isAuthenticated()">
									...
									<c:choose>
										<c:when
											test="${authList.stream().anyMatch(authVO->authVO.auth.equals('ROLE_ADMIN')).get()}">
											<!-- admin 계정만 할 수 있는 일처리 -->
											<li><a class="dropdown-item" href="/member/list">관리자>${authNick}(${authEmail})Member
													List</a></li>
											...
											<li><a class="dropdown-item"
												href="/member/detail?email=${authEmail}">${authNick}님의 Member DetailMember Detail</a></li>

										</c:when>
										<c:otherwise>

											<li class="dropdown-item">${authNick}(${authEmail})
												환영합니다.</li>

											<li><a class="dropdown-item"
												href="/member/detail?email=${authEmail}">${authNick}님의 Member Detail</a></li>
